...
const Skills = () => {
  ...
  const techSkillsToShow = showMoreTechSkills ? allTechnicalSkills : allTechnicalSkills.slice(0, 8);
  const languagesToShow = showMoreLanguages ? allLanguages : allLanguages.slice(0, 8);
  const otherSkillsToShow = showMoreOtherSkills ? allOtherSkills : allOtherSkills.slice(0, 8);
